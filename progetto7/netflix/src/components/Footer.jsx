    ...
    <div className="bg-black text-light">
      <Container fluid className="py-5">
        <Row className="d-flex">
          <Col md={2} className="text-center text-md-start mb-3 mb-md-0" style={{ fontSize: '0.5em' }}>
            <div className="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-start">
              <div className="me-md-3 mb-3 mb-md-0">
                ...
                <ul className="list-unstyled text-center text-md-start  mx-5">
                  ...
                  <Button variant="outline-light" className="mb-2 rounded-0" style={{ fontSize: '0.8em' }}>
                    Service Code
                  </Button>
                  <p className="mb-0 " >
          ...
          <Col md={2} className="text-center text-md-start mb-3 mb-md-0" style={{ fontSize: '0.5em' }}>
            <div className="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-start">
              <div className="me-md-3 mb-3 mb-md-0">
                <FaFacebookSquare size={18} className="text-black me-3 mb-3 mt-5 " />
